...
class MasterSectionController extends Controller
{
    public function index()
    {
        ...
        $data = MasterSection::orderBy('id', 'asc')->when($insId, function ($q) use ($insId) {
        ...
        return view('backend.master-section.list', [
            'data' => $data,
    ...
    public function store (Request $request) {
        ...
        $request->validate([
            ...
            'section_name' => [
                'required',
                 Rule::unique('sections')->where(function ($q) use ($request, $id) {
        ...
        if ($id) {
            ...
            $data = MasterSection::create($all_data);
        }
    ...
    public function changeStatus(Request $request){
        ...
        $model = MasterSection::find($request->id);
