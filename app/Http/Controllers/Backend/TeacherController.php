...
class TeacherController extends Controller
{
    public function index()
    {
        ...
        return view('backend.teacher.list', ['data' => $data]);
    }
    ...
    public function add () {
        ...
        return view('backend.teacher.add', ['instituteList' => $instituteList, 'institute_id' => $insId ?? 0]);
    }
    ...
    public function edit ($id) {
        if ($id) {
            ...
            if ($data) {
                $instituteList = CommonDataService::instituteList();
                return view('backend.teacher.edit', [ 'data' => $data, 'instituteList' => $instituteList ]);
            }
        }
