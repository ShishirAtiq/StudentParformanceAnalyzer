...
@section('content')
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Marks Settings</li>
              </ol>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Marks Settings List</h3>
                @can('isAdmin')
                <a href="{{ route('backend.marks-settings.add') }}" class="btn btn-primary btn-sm" style="float: right;">
  ...
  <script>
    ...
    function changeStatus (id) {
      const uri = '/marks-settings/toggle-status';  
      toggleStatus(uri, id)
    }
