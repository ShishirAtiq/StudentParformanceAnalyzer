...
@section('content')
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Performance Attribute</li>
              </ol>
          </div>
          <div class="col-sm-6">
      ...
      <div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-md" role="document">
            <form id="submittedForm">
                @csrf
                @include('backend.performance-attribute.form_modal')
            </form>
          </div>
      </div>
  ...
  <script src="{{asset('/backend/custom-js/performance_attribute.js')}}"></script>
  ...
  <script>
    ...
    function add (instituteList, instituteId) {
      ...
      $('#mydropdown').text('');
      $("#exampleModalLabel").text("Attribute Entry");
      $("#id").val('');
    ...
    function edit (item, instituteList) {
      ...
      $("#exampleModalLabel").text("Attribute Modify");
      $('#mydropdown').text('');
      ...
      $("#attribute_name").val(item.attribute_name);
    }

    function changeStatus (id) {
      const uri = '/performance-attribute/toggle-status';  
      toggleStatus(uri, id)
    }
