...
@section('content')
      ...
      <div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-md" role="document">
            <form id="submittedForm">
                @csrf
                @include('backend.master-subject.form_modal')
            </form>
          </div>
      </div>
  ...
  <script src="{{asset('/backend/custom-js/master_subject.js')}}"></script>
  ...
  <script>
    ...
    function add (instituteList, instituteId, classList) {
      ...
      $('#mydropdown').text('');
      $("#exampleModalLabel").text("Subject Entry");
      $("#id").val('');
    ...
    function edit (item, instituteList, classList, groupList) {
      ...
      $("#exampleModalLabel").text("Subject Modify");
      $('#mydropdown').text('');
